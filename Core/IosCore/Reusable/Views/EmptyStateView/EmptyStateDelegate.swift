...
extension EmptyStateDelegate where Self: UIResponder {
    ...
    /// Default empty implementation of `superviewShouldClip`
    public func superviewShouldClip() -> Bool { return true }
}
