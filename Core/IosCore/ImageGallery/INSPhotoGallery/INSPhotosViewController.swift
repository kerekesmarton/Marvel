...
typealias INSPhotosViewControllerReferenceViewHandler = (_ photo: INSPhotoViewable) -> (UIView?)
typealias INSPhotosViewControllerNavigateToPhotoHandler = (_ photo: INSPhotoViewable) -> ()
typealias INSPhotosViewControllerDismissHandler = (_ viewController: INSPhotosViewController) -> ()
typealias INSPhotosViewControllerLongPressHandler = (_ photo: INSPhotoViewable, _ gestureRecognizer: UILongPressGestureRecognizer) -> (Bool)
typealias INSPhotosViewControllerDeletePhotoHandler = (_ photo: INSPhotoViewable) -> ()


class INSPhotosViewController: UIViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, UIViewControllerTransitioningDelegate {
    
    /* 
     * Returns the view from which to animate for object conforming to INSPhotoViewable 
     */
    var referenceViewForPhotoWhenDismissingHandler: INSPhotosViewControllerReferenceViewHandler?
    
    /*
     * Called when a new photo is displayed through a swipe gesture.
     */
    var navigateToPhotoHandler: INSPhotosViewControllerNavigateToPhotoHandler?
    
    /*
     * Called before INSPhotosViewController will start a user-initiated dismissal.
     */
    var willDismissHandler: INSPhotosViewControllerDismissHandler?
    
    /*
     * Called after the INSPhotosViewController has been dismissed by the user.
     */
    var didDismissHandler: INSPhotosViewControllerDismissHandler?
    
    /*
     * Called when a photo is long pressed.
     */
    var longPressGestureHandler: INSPhotosViewControllerLongPressHandler?
    
    /*
     * Called when delete is tapped on a photo
     */
    var deletePhotoHandler: INSPhotosViewControllerDeletePhotoHandler?
    
    /*
     * The overlay view displayed over photos, can be changed but must implement INSPhotosOverlayViewable
     */
    var overlayView: INSPhotosOverlayViewable = INSPhotosOverlayView(frame: CGRect.zero) {
        willSet {
     ...
     */
    var currentPhotoViewController: INSPhotoViewController? {
     ...
     */
    var currentPhoto: INSPhotoViewable? {
     ...
     */
    init(photos: [INSPhotoViewable], initialPhoto: INSPhotoViewable? = nil, referenceView: UIView? = nil) {
    ...
    private func updateCurrentPhotosInformation() {
        if let currentPhoto = currentPhoto, let fontCalculating = self as? FontCalculating {
            overlayView.populateWithPhoto(currentPhoto, fontCaclulating: fontCalculating)
        }
    }
     ...
     */
    func changeToPhoto(_ photo: INSPhotoViewable, animated: Bool, direction: UIPageViewController.NavigationDirection = .forward) {
    ...
    func initializePhotoViewControllerForPhoto(_ photo: INSPhotoViewable) -> INSPhotoViewController {
