 ...
 */
protocol INSPhotoViewable: class {
    ...
    var caption: [FontCalculable]? { get }
    var secondCaption: [FontCalculable]? { get }
}

@objc class INSPhoto: NSObject, INSPhotoViewable {
    var caption: [FontCalculable]?
    
    var secondCaption: [FontCalculable]?
    
    @objc var image: UIImage?
    @objc var thumbnailImage: UIImage?
    @objc var isDeletable: Bool
    ...
    @objc func loadImageWithCompletionHandler(_ completion: @escaping (_ image: UIImage?, _ error: Error?) -> ()) {
        if let image = image {
    ...
    @objc func loadThumbnailImageWithCompletionHandler(_ completion: @escaping (_ image: UIImage?, _ error: Error?) -> ()) {
...
func ==<T: INSPhoto>(lhs: T, rhs: T) -> Bool {
    return lhs === rhs
}
